System.register("engine/MainLoop", [], function (exports_1, context_1) {
    "use strict";
    var MainLoop;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_1("default", MainLoop);
        }
    };
});
System.register("examples/002-texture/main", ["engine/MainLoop"], function (exports_2, context_2) {
    "use strict";
    var MainLoop_1, Example002_Texture, ex;
    var __moduleName = context_2 && context_2.id;
    return {
        setters: [
            function (MainLoop_1_1) {
                MainLoop_1 = MainLoop_1_1;
            }
        ],
        execute: function () {
            Example002_Texture = /** @class */ (function () {
